...
public class Board implements Serializable {
	...
	public Board(int bo_no, String bo_title, String bo_writer, String bo_passwd, String bo_email,
			     String bo_content, String bo_ip, int bo_read_cnt, String bo_reg_date, String bo_mod_date) {
	super();
	this.bo_no = bo_no;
